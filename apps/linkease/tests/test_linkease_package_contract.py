...
class LinkEasePackageContractTest(unittest.TestCase):
    ...
    def test_standard_linkease_uses_legacy_runtime_only(self):
        ...
        self.assertIn("PKG_VERSION:=1.7.5", makefile)
    ...
    def test_linkeasefull_is_dependent_full_runtime_package(self):
        ...
        self.assertNotIn("linkease-desktop", makefile)
        self.assertIn("6d5e325ae13b651f77a5cff3525fe1801c7428cfc3584c9b89052e3625b34c65", makefile)
        self.assertIn("4f637ea0e5d41a8aca7c833c05cb64d821d9cbc08d924d9d28951c30ca85856b", makefile)
