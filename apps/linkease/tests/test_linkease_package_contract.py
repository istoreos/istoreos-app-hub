...
class LinkEasePackageContractTest(unittest.TestCase):
    ...
    def test_linkeasefull_is_dependent_full_runtime_package(self):
        ...
        self.assertNotIn("linkease-desktop", makefile)
        self.assertIn("6eebe493f452593889b750a16f6a286fd43411a51a334b0ab8c914e3d96fd670", makefile)
        self.assertIn("947e3305ab78cba8be319b9d59960875c4e2ddb8517b14629504bba0bdc3e8f1", makefile)
