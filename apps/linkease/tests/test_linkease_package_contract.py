...
class LinkEasePackageContractTest(unittest.TestCase):
    ...
    def test_linkeasefull_is_dependent_full_runtime_package(self):
        ...
        self.assertNotIn("linkease-desktop", makefile)
        self.assertIn("942d04302781f8029d3a05fdc10cb7f1d31df1773c690c47df21dfcd028ebbb6", makefile)
        self.assertIn("9de58f0617392420787c4b2f49888fa3c77a1212166918c7c5ff01873d2b4e24", makefile)
