...
class LinkEasePackageContractTest(unittest.TestCase):
    ...
    def test_linkeasefull_is_dependent_full_runtime_package(self):
        ...
        self.assertIn("PKG_SOURCE_DATE:=3.0.13", makefile)
        self.assertIn("ARCH_HEXCODE=8664", makefile)
        self.assertIn("ARCH_HEXCODE=aa64", makefile)
        self.assertIn("PKG_SOURCE_VERSION:=$(ARCH_HEXCODE)", makefile)
        ...
        self.assertNotIn("linkease-desktop", makefile)
        self.assertIn("12549b0e4c1cdecfea9aee4aecc04ca3acdd25d421e83a0f7f3b4627e0b8db2c", makefile)
        self.assertIn("2ba877e84d14a2e0d086259733136c3ec4900e0d29a25b0b8cab3eeaa0443796", makefile)
        ...
        self.assertNotIn("linkease_enabled()", init)
        self.assertNotIn('uci -q get linkease.@linkease[0].enabled', init)
        self.assertNotIn("please disable linkease before starting linkeasefull", init)
        ...
        self.assertIn("PKG_VERSION:=3.0.13", meta)
